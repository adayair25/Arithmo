...
SYNTAX = f""" 
    ?start: exp+
    ?exp: sum
      | FUNCTIONS_CALL LPAREN MODES COMMA STRING? COMMA ( ( ( LBRACKET (INT COMMA INT COMMA INT COMMA INT) RBRACKET ) | FUNCTION_EXP) COMMA ) ( ( ( LBRACKET (INT COMMA INT COMMA INT COMMA INT) RBRACKET ) | FUNCTION_EXP)) (CONSTANTS EQUAL LBRACKET (INT COMMA)+ RBRACKET)? RPAREN SEMICOLON -> deriv_gen
